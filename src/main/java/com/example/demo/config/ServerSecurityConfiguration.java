...
import com.example.demo.config.encryption.EncodersConfiguration;
...
//             .permitAll();
    ...
    public AuthFilterConfiguration authenticationFilter() throws Exception {
        AuthFilterConfiguration filter = new AuthFilterConfiguration();
